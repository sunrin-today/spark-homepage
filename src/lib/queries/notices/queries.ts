...
export const useNotices = (page: number = 1, limit: number = 10, query?: string) => {
  return useQuery({
    queryKey: [...noticeKeys.lists(), page, limit, query],
    queryFn: () => noticesApi.getNotices(page, limit, query),
